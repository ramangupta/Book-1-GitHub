...
This part builds the reader’s core understanding from absolute zero.

It is designed for someone who has never used Git or GitHub before, and may not even fully understand how modern software is managed. Instead of assuming prior knowledge, this section carefully constructs the mental model required to use GitHub confidently.
